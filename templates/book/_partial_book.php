...
<div class="col-md-4 my-2 d-flex">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="index.php?controller=book&action=show&id=<?= $book->getId(); ?>" class="btn btn-primary">Read more</a>
            <?php if (User::isLogged() && User::isAdmin()) { ?>
                <a href="index.php?controller=book&action=edit&id=<?= $book->getId(); ?>" class="btn btn-primary">Modify</a>
