    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="index.php?controller=book&amp;action=show&amp;id=79" class="btn btn-primary">Read more</a>
            </div>
        </div>
    </div>
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore ...</p>
                <a href="index.php?controller=book&amp;action=show&amp;id=78" class="btn btn-primary">Read more</a>
            </div>
        </div>
    </div>
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore ...</p>
                <a href="index.php?controller=book&amp;action=show&amp;id=77" class="btn btn-primary">Read more</a>
            </div>
        </div>
    </div>
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore ...</p>
                <a href="index.php?controller=book&amp;action=show&amp;id=76" class="btn btn-primary">Read more</a>
            </div>
        </div>
    </div>
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore ...</p>
                <a href="index.php?controller=book&amp;action=show&amp;id=75" class="btn btn-primary">Read more</a>
            </div>
        </div>
    </div>
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore ...</p>
                <a href="index.php?controller=book&amp;action=show&amp;id=74" class="btn btn-primary">Read more</a>
            </div>
        </div>
    </div>
</div>
